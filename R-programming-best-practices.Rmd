...
2.  [Advanced R - Hadley Wickham](http://adv-r.had.co.nz/) (Good overview of R software development foundations and styling)
...
5.  [Testing basics in R - r-pkgs](https://r-pkgs.org/testing-basics.html) - general theory and basics tutorial about unit testing in R
6.  R packages
